        ...
        },
        {
            ...
            "inputs": [
                ...
                },
                {
                    ...
                    "id": "#get_spike_in_counts.cwl/reference_spike_in"
                },
                {
                    "type": "string",
            ...
            "steps": [
                {
                    ...
                    "in": [
                        ...
                        },
                        {
                            ...
                            "id": "#get_spike_in_counts.cwl/count_aligned_reads/is_paired_end"
                        }
                    ],
                    "out": [
                ...
                },
                {
                    ...
                    "in": [
                        ...
                        {
                            "source": "#get_spike_in_counts.cwl/reference_spike_in",
                            "id": "#get_spike_in_counts.cwl/mapping/reference_index"
                        }
                    ],
                    "out": [
        ...
        },
        {
                    ...
                    "in": [
                        {
                            ...
                            "id": "#merge_filter.cwl/qc_duprem/bam"
                        }
                    ],
                    "out": [
                        "#merge_filter.cwl/qc_duprem/fastqc_zip",
                        "#merge_filter.cwl/qc_duprem/fastqc_html"
                    ],
                    "id": "#merge_filter.cwl/qc_duprem"
                },
                {
            ...
            "outputs": [
                ...
                },
                {
                    ...
                    "outputSource": "#merge_filter.cwl/qc_duprem/fastqc_html",
                    "id": "#merge_filter.cwl/duprem_fastqc_html"
                },
                {
                    "type": {
                        "type": "array",
                    ...
                    "outputSource": "#merge_filter.cwl/qc_duprem/fastqc_zip",
                    "id": "#merge_filter.cwl/duprem_fastqc_zip"
                }
            ],
            "id": "#merge_filter.cwl"
        },
        ...
        },
        {
            ...
            "steps": [
                    ...
                    "in": [
                        {
                            "source": [
                                ...
                                "#main/merge_filter/duprem_fastqc_zip",
                                "#main/merge_filter/duprem_fastqc_html",
                                "#main/chip_qc/qc_plot_coverage_tsv",
                                "#main/chip_qc/qc_plot_coverage_plot",
                                "#main/chip_qc/qc_plot_fingerprint_tsv",
                                "#main/chip_qc/qc_plot_fingerprint_plot",
                ...
                },
                {
                    ...
                    "in": [
                        ...
                        {
                            "source": "#main/reference_spike_in",
                            "id": "#main/get_spike_in_counts/reference_spike_in"
                        },
                        {
                            "source": "#main/sample_id",
            ...
            "outputs": [
                ...
                },
                {
                    ...
                    "outputSource": "#main/merge_filter/duprem_fastqc_html",
                ...
                },
                {
                    ...
                    "outputSource": "#main/merge_filter/duprem_fastqc_zip",
