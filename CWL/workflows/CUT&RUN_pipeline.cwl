    ...
    in:
      ...
      qc_files_array:
        source:
          ...
          - merge_filter/post_filter_fastqc_zip
          - merge_filter/post_filter_fastqc_html
...
outputs:
  ...
  post_filter_fastqc_zip:
    type:
      type: array
      items: File
    outputSource: merge_filter/post_filter_fastqc_zip
  post_filter_fastqc_html:
    type:
      type: array
      items: File
    outputSource: merge_filter/post_filter_fastqc_html
  bam:
    type: File
    secondaryFiles: .bai
